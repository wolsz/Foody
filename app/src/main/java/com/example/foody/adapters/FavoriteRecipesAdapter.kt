...
) : ListAdapter<FavoritesEntity, FavoriteRecipesAdapter.MyViewHolder>(FavoritesEntityDiffCallback),
    ActionMode.Callback {
...
object FavoritesEntityDiffCallback : DiffUtil.ItemCallback<FavoritesEntity>() {
